...
namespace Net.Infrastructure.BaseTypes.Actions
{
    ...
    /// </summary>
    public interface IGetByGuidAndRequest<in TRequest, TResponse>
    {
        /// <summary>
        ...
        Task<ActionResult<TResponse>> GetByGuidAndRequestAsync([FromRoute] Guid id, [FromQuery] TRequest request);
    }
}
